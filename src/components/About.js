...
const ProfilePic = styled(Paper)({margin:0,float: 'right', clear: 'left', borderRadius:0,padding:6});
const SkillList = styled('ul')({paddingLeft:'6vh', flexDirection: 'column', flexWrap: 'wrap', display: 'flex', height: '10vh'});
...
export default function About() {
    return (
        <Container id="about">
            ...
            <MainContent>
                <Content>
                    <ProfilePic><img src={MePic} alt="Luis Gimenez, Software Developer"/></ProfilePic>
                    <AboutMe>
