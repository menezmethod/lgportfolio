...
<div align="center"><a href="https://github.com/menezmethod/StudentRosterLG_CPP" target="new">[View On GitHub]</a></div>
                    ...
                    {/* <MyWork>
                        <PortfolioList>
                            <PortfolioLi>
                                <h5>
                                    <a href="https://github.com/menezmethod/inventorysystemreact" target="_blank">// Inventory System created developed using SpringBoot and React</a>
                                </h5>
                            </PortfolioLi>
                            <PortfolioLi>
                                <h5>
                                    <a href="https://github.com/menezmethod/InventorySystem_JavaFX" target="_blank">// Inventory System created developed using Java and JavaFX</a>
                                </h5>
                            </PortfolioLi>
                            <PortfolioLi>
                                <h5>
                                    <a href="https://github.com/menezmethod/JSScheduleLG_java" target="_blank">// Multi time-zone Scheduling Application developed using Java and JavaFX</a>
                                </h5>
                            </PortfolioLi>
                            <PortfolioLi>
                                <h5>
                                    <a href="https://github.com/menezmethod/StudentRosterLG_CPP" target="_blank">// Student Roster developed using C++</a>
                                </h5>
                            </PortfolioLi>
                            <PortfolioLi>
                                <h5>
                                    <a href="https://github.com/menezmethod/WGUSchedulerMobile" target="_blank">// Mobile Semester Scheduling application developed using Java &amp; Android Studio</a>
                                </h5>
                            </PortfolioLi>
                            <PortfolioLi>
                                <h5>
