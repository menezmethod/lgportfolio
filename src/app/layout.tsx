...
export const metadata: Metadata = {
  title: "Luis Gimenez | Site Reliability Engineer — Go, GCP, Observability, Distributed Systems",
  description:
    "Site reliability engineer at Fortune 50 scale. SRE for Home Services at The Home Depot — distributed tracing, SLO-driven reliability, and incident response across scheduling, dispatch, and fulfillment. GCP Professional Cloud Architect. Tampa Bay / remote.",
  keywords: [
  ...
  openGraph: {
    title: "Luis Gimenez | Site Reliability Engineer — Go, GCP, Observability, Distributed Systems",
    description:
      "Site reliability engineer at Fortune 50 scale. SRE for Home Services at The Home Depot — distributed tracing, SLO-driven reliability, incident response. GCP Professional Cloud Architect. Tampa Bay / remote.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Site reliability engineer at Fortune 50 scale. SRE for Home Services at The Home Depot — distributed tracing, SLO-driven reliability, and incident response. GCP Professional Cloud Architect.",
            url: "https://gimenez.dev",
            sameAs: [
