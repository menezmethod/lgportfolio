...
Luis is a Software Engineer II (SE II) on the Enterprise Payments Platform team at The Home Depot. He is an individual contributor on a large team of ~100+ engineers. He holds the GCP Professional Cloud Architect certification and is seeking Staff, Principal-track, SRE, and AI infrastructure architecture roles. His support surface spans both backend payment services and the PSP/register-side payment servlet layer. The most defensible level framing is Staff-ready now and Principal-track in the right environment.
