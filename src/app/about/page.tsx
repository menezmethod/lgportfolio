...
const skills = {
  ...
  cloud: ['Google Cloud Platform', 'GCP Professional Architect', 'Cloud Run', 'GKE', 'BigQuery'],
  frameworks: ['React', 'Next.js', 'Node.js', 'Spring Boot', 'Express'],
  tools: ['Docker', 'Kubernetes', 'Terraform', 'Git', 'CI/CD', 'REST APIs'],
  domains: ['Payment Systems', 'Microservices', 'System Architecture', 'Legacy Modernization', 'AI/ML'],
};
    ...
    <div className="min-h-screen bg-black text-white pt-24 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-12">
          <span className="text-cyan-400 font-mono">[0]</span> About Me
        </h1>

        <div className="grid md:grid-cols-3 gap-12">
          <div className="md:col-span-2 space-y-6 text-gray-300">
            <p>
              I am a results-driven Software Engineer II at <span className="text-cyan-400">The Home Depot</span>, 
              where I architect and maintain mission-critical payment processing infrastructures handling 
              <span className="text-cyan-400"> millions in daily transactions</span>.
            </p>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">Professional Work @ Home Depot</h2>
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">▹</span>
                Architecting scalable solutions on GCP (Professional Architect certified)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">▹</span>
            ...
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">Personal Innovation Projects</h2>
            <p>
              In my personal time, I explore cutting-edge technologies and build innovative solutions. 
              My latest project, <span className="text-cyan-400">Churnistic</span>, demonstrates my passion 
            ...
            <div className="bg-gray-900/50 rounded-lg p-6 border border-white/10">
              ...
              <div className="space-y-6">
                {Object.entries(skills).map(([category, items]) => (
                  <div key={category}>
                    <h4 className="text-sm font-mono text-cyan-400 mb-2 capitalize">{category}</h4>
