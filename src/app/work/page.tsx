...
const projects: Project[] = [
  {
    ...
    gcp: 'GKE, BigQuery',
    metrics: { scale: 'Enterprise-scale', availability: 'Platinum-tier SLO', latency: 'Sub-50ms p99', improvement: 'Observability-driven' },
    featured: true,
    type: 'professional',
  },
  {
    ...
    solution: 'Engineered a full RAG pipeline: local knowledge base, optional GCP Cloud SQL (pgvector) for semantic search, self-hosted inference via Inferencia (OpenAI-compatible). Deployed on GCP Cloud Run with Terraform IaC.',
    ...
    stack: ['Next.js 16', 'TypeScript', 'AI SDK', 'Cloud SQL pgvector', 'Terraform', 'Cloud Run', 'Docker'],
  ...
  },
  {
    ...
    demo: 'https://github.com/menezmethod/churnistic',
