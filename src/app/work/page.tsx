...
const projects: Project[] = [
  {
    ...
    description: 'Contributor-level backend and operations work in the payment-card tender domain across a large enterprise platform.',
    ...
    solution: 'Contributed to distributed buffering and service-hardening work using Pub/Sub and Cloud Run patterns, and built OpenTelemetry/Grafana observability pipelines to make the payment path measurable during incidents.',
    impact: 'Zero-downtime operational posture during high-volume periods, stronger troubleshooting speed, and latency improvements driven by observability insights.',
    ...
    metrics: { scale: '185K+/hour context', team: '100+ engineers', focus: 'Observability + Ops', role: 'SE II Contributor' },
    featured: true,
    type: 'professional',
  },
  {
    ...
    solution: 'Engineered a production-ready chat pipeline: hardened system prompt, local knowledge-base retrieval, and self-hosted gpt-oss inference on a MacBook Pro M4 Max through an OpenAI-compatible endpoint.',
    impact: 'Live production system demonstrating realistic recruiter Q&A, prompt-injection defenses, and measurable LLM behavior checks through a CLI evaluation API.',
    stack: ['Next.js 16', 'TypeScript', 'Vercel AI SDK', 'gpt-oss', 'Terraform', 'Cloud Run', 'Docker'],
    ...
    metrics: { cost: '~$18-20/mo', infra: 'Terraform IaC', ai: 'Local gpt-oss', deployment: 'Cloud Run' },
    featured: true,
    type: 'personal',
  },
  {
